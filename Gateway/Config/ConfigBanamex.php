...
/**
 * Gateway setting for the payment method for Banamex.
 */
class ConfigBanamex extends PaymentConfig
{
    /**
     * Method.
     */
    public const METHOD = 'mercadopago_paymentmagento_banamex';

    /**
     * Payment Method Id Banamex.
     */
    public const PAYMENT_METHOD_ID = 'banamex';
    ...
    /**
     * Instruction Checkout Banamex.
     */
    public const INSTRUCTION_CHECKOUT_BANAMEX = 'instruction_checkout_banamex';
    ...
    /**
     * Get Instruction Checkoout for Banamex.
     *
     * @param int|null $storeId
     *
     * @return string
     */
    public function getInstructionCheckoutBanamex($storeId = null): string
    {
        $pathPattern = 'payment/%s/%s';

        return $this->scopeConfig->getValue(
            sprintf($pathPattern, self::METHOD, self::INSTRUCTION_CHECKOUT_BANAMEX),
            ScopeInterface::SCOPE_STORE,
            $storeId
        );
    }
