...
/**
 * Gateway setting for the payment method for Bancomer.
 */
class ConfigBancomer extends PaymentConfig
{
    /**
     * Method.
     */
    public const METHOD = 'mercadopago_paymentmagento_bancomer';

    /**
     * Payment Method Id Bancomer.
     */
    public const PAYMENT_METHOD_ID = 'bancomer';
    ...
    /**
     * Instruction Checkout Bancomer.
     */
    public const INSTRUCTION_CHECKOUT_BANCOMER = 'instruction_checkout_bancomer';
    ...
    /**
     * Get Instruction Checkoout for Bancomer.
     *
     * @param int|null $storeId
     *
     * @return string
     */
    public function getInstructionCheckoutBancomer($storeId = null): string
    {
        $pathPattern = 'payment/%s/%s';

        return $this->scopeConfig->getValue(
            sprintf($pathPattern, self::METHOD, self::INSTRUCTION_CHECKOUT_BANCOMER),
            ScopeInterface::SCOPE_STORE,
            $storeId
        );
    }
