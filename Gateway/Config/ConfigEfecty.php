...
/**
 * Gateway setting for the payment method for Efecty.
 */
class ConfigEfecty extends PaymentConfig
{
    /**
     * Method.
     */
    public const METHOD = 'mercadopago_paymentmagento_efecty';

    /**
     * Payment Method Id Efecty.
     */
    public const PAYMENT_METHOD_ID = 'efecty';
    ...
    /**
     * Instruction Checkout Efecty.
     */
    public const INSTRUCTION_CHECKOUT_PAYCASH = 'instruction_checkout_efecty';
    ...
    /**
     * Get Instruction Checkoout for Efecty.
     *
     * @param int|null $storeId
     *
     * @return string
     */
    public function getInstructionCheckoutEfecty($storeId = null): string
    {
        $pathPattern = 'payment/%s/%s';
