...
/**
 * Gateway setting for the payment method for Oxxo.
 */
class ConfigOxxo extends PaymentConfig
{
    /**
     * Method.
     */
    public const METHOD = 'mercadopago_paymentmagento_oxxo';

    /**
     * Payment Method Id Oxxo.
     */
    public const PAYMENT_METHOD_ID = 'oxxo';
    ...
    /**
     * Instruction Checkout Oxxo.
     */
    public const INSTRUCTION_CHECKOUT_PAYCASH = 'instruction_checkout_oxxo';
    ...
    /**
     * Get Instruction Checkoout for Oxxo.
     *
     * @param int|null $storeId
     *
     * @return string
     */
    public function getInstructionCheckoutOxxo($storeId = null): string
    {
        $pathPattern = 'payment/%s/%s';
