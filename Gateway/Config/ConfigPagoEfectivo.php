...
/**
 * Gateway setting for the payment method for Pago Efectivo.
 */
class ConfigPagoEfectivo extends PaymentConfig
{
    /**
     * Method.
     */
    public const METHOD = 'mercadopago_paymentmagento_pagoefectivo';

    /**
     * Payment Method Id Pago Efectivo.
     */
    public const PAYMENT_METHOD_ID = 'pagoefectivo_atm';
    ...
    /**
     * Instruction Checkout Pago Efectivo.
     */
    public const INSTRUCTION_CHECKOUT_PAGOEFECTIVO = 'instruction_checkout_pagoefectivo';
    ...
    /**
     * Get Instruction Checkoout for PagoEfectivo.
     *
     * @param int|null $storeId
     *
     * @return string
     */
    public function getInstructionCheckoutPagoEfectivo($storeId = null): string
    {
        $pathPattern = 'payment/%s/%s';

        return $this->scopeConfig->getValue(
            sprintf($pathPattern, self::METHOD, self::INSTRUCTION_CHECKOUT_PAGOEFECTIVO),
            ScopeInterface::SCOPE_STORE,
            $storeId
        );
    }
