...
/**
 * Gateway setting for the payment method for Pago Fácil.
 */
class ConfigPagoFacil extends PaymentConfig
{
    /**
     * Method.
     */
    public const METHOD = 'mercadopago_paymentmagento_pagofacil';

    /**
     * Payment Method Id Pago Fácil.
     */
    public const PAYMENT_METHOD_ID = 'pagofacil';
    ...
    /**
     * Instruction Checkout Pago Fácil.
     */
    public const INSTRUCTION_CHECKOUT_PAGOFACIL = 'instruction_checkout_pagofacil';
    ...
    /**
     * Get Instruction Checkoout for PagoFacil.
     *
     * @param int|null $storeId
     *
     * @return string
     */
    public function getInstructionCheckoutPagoFacil($storeId = null): string
    {
        $pathPattern = 'payment/%s/%s';

        return $this->scopeConfig->getValue(
            sprintf($pathPattern, self::METHOD, self::INSTRUCTION_CHECKOUT_PAGOFACIL),
            ScopeInterface::SCOPE_STORE,
            $storeId
        );
    }
