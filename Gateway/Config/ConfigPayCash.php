...
/**
 * Gateway setting for the payment method for PayCash.
 */
class ConfigPayCash extends PaymentConfig
{
    /**
     * Method.
     */
    public const METHOD = 'mercadopago_paymentmagento_paycash';

    /**
     * Payment Method Id PayCash.
     */
    public const PAYMENT_METHOD_ID = 'paycash';
    ...
    /**
     * Instruction Checkout PayCash.
     */
    public const INSTRUCTION_CHECKOUT_PAYCASH = 'instruction_checkout_paycash';
    ...
    /**
     * Get Instruction Checkoout for PayCash.
     *
     * @param int|null $storeId
     *
     * @return string
     */
    public function getInstructionCheckoutPayCash($storeId = null): string
    {
        $pathPattern = 'payment/%s/%s';
