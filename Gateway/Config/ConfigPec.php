...
/**
 * Gateway setting for the payment method for PEC.
 */
class ConfigPec extends PaymentConfig
{
    /**
     * Method.
     */
    public const METHOD = 'mercadopago_paymentmagento_pec';

    /**
     * Payment Method Id Pec.
     */
    public const PAYMENT_METHOD_ID = 'pec';
    ...
    /**
     * Instruction Checkout Pec.
     */
    public const INSTRUCTION_CHECKOUT_PEC = 'instruction_checkout_pec';
    ...
    /**
     * Get Instruction Checkoout for Pec.
     *
     * @param int|null $storeId
     *
     * @return string
     */
    public function getInstructionCheckoutPec($storeId = null): string
    {
        $pathPattern = 'payment/%s/%s';

        return $this->scopeConfig->getValue(
            sprintf($pathPattern, self::METHOD, self::INSTRUCTION_CHECKOUT_PEC),
            ScopeInterface::SCOPE_STORE,
            $storeId
        );
    }
