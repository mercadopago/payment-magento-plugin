...
/**
 * Gateway setting for the payment method for Rapi Pago.
 */
class ConfigRapiPago extends PaymentConfig
{
    /**
     * Method.
     */
    public const METHOD = 'mercadopago_paymentmagento_rapipago';

    /**
     * Payment Method Id Rapi Pago.
     */
    public const PAYMENT_METHOD_ID = 'rapipago';
    ...
    /**
     * Instruction Checkout Rapi Pago.
     */
    public const INSTRUCTION_CHECKOUT_RAPIPAGO = 'instruction_checkout_rapipago';
    ...
    /**
     * Get Instruction Checkoout for Rapi Pago.
     *
     * @param int|null $storeId
     *
     * @return string
     */
    public function getInstructionCheckoutRapiPago($storeId = null): string
    {
        $pathPattern = 'payment/%s/%s';

        return $this->scopeConfig->getValue(
            sprintf($pathPattern, self::METHOD, self::INSTRUCTION_CHECKOUT_RAPIPAGO),
            ScopeInterface::SCOPE_STORE,
            $storeId
        );
    }
