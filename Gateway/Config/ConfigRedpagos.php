...
/**
 * Gateway setting for the payment method for Redpagos.
 */
class ConfigRedpagos extends PaymentConfig
{
    /**
     * Method.
     */
    public const METHOD = 'mercadopago_paymentmagento_redpagos';

    /**
     * Payment Method Id Redpagos.
     */
    public const PAYMENT_METHOD_ID = 'redpagos';
    ...
    /**
     * Instruction Checkout Redpagos.
     */
    public const INSTRUCTION_CHECKOUT_PAYCASH = 'instruction_checkout_redpagos';
    ...
    /**
     * Get Instruction Checkoout for Redpagos.
     *
     * @param int|null $storeId
     *
     * @return string
     */
    public function getInstructionCheckoutRedpagos($storeId = null): string
    {
        $pathPattern = 'payment/%s/%s';
