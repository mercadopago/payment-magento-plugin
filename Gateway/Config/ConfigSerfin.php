...
/**
 * Gateway setting for the payment method for Serfin.
 */
class ConfigSerfin extends PaymentConfig
{
    /**
     * Method.
     */
    public const METHOD = 'mercadopago_paymentmagento_serfin';

    /**
     * Payment Method Id Serfin.
     */
    public const PAYMENT_METHOD_ID = 'serfin';
    ...
    /**
     * Instruction Checkout Serfin.
     */
    public const INSTRUCTION_CHECKOUT_SERFIN = 'instruction_checkout_serfin';
    ...
    /**
     * Get Instruction Checkoout for Serfin.
     *
     * @param int|null $storeId
     *
     * @return string
     */
    public function getInstructionCheckoutSerfin($storeId = null): string
    {
        $pathPattern = 'payment/%s/%s';

        return $this->scopeConfig->getValue(
            sprintf($pathPattern, self::METHOD, self::INSTRUCTION_CHECKOUT_SERFIN),
            ScopeInterface::SCOPE_STORE,
            $storeId
        );
    }
