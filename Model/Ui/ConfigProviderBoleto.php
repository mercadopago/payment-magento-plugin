...
/**
 * User interface model for settings Boleto.
 */
class ConfigProviderBoleto implements ConfigProviderInterface
{
    /**
     * Mercado Pago Payment Magento Boleto Code.
     */
    public const CODE = 'mercadopago_paymentmagento_boleto';
        ...
        return [
            'payment' => [
                ConfigBoleto::METHOD => [
                    ...
                    'logo'                            => $this->getLogo(),
                    'payment_method_id'               => ConfigBoleto::PAYMENT_METHOD_ID,
                ],
            ],
        ];
    }
    ...
    {
        $text = $this->config->getInstructionCheckoutBoleto($storeId);
