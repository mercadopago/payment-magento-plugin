 ...
 */
class ConfigProviderWebpay implements ConfigProviderInterface
{
    /**
        ...
        return [
            'payment' => [
                ConfigWebpay::METHOD => [
                    ...
                    'instruction_checkout_webpay'     => nl2br($this->getDescriptions($storeId)),
                    'logo'                            => $this->getLogo(),
    ...
    {
        $text = $this->config->getInstructionCheckoutWebpay($storeId);
